...
@Composable
fun TelaAdicionarViagem(controleDeNavegacao: NavHostController) {
            ...
            Column(
                ...
                Column(
                    ...
                    Text(
                        ...
                        text = stringResource(id = R.string.sign_up_top_label)
                    )
                    Text(
                        fontFamily = FontFamily.Default,
                        fontSize = 16.sp,
                        ...
                        text = stringResource(id = R.string.sign_up_create_account_top_message)
                    )
            ...
            Column(
                ...
                Column(
                        ...
                        OutlinedTextField(
                            ...
                            label = {
                                Text(
                                    ...
                                    fontStyle = FontStyle.Normal,
                                    fontWeight = FontWeight.Light,
                                    text = stringResource(id = R.string.sign_up_phone)
                                )
                            },
                            placeholder = {
                                Text(
                                    ...
                                    fontStyle = FontStyle.Normal,
                                    fontWeight = FontWeight.Light,
                                    text = stringResource(id = R.string.sign_up_phone_message)
                                )
                            },
                            keyboardOptions = KeyboardOptions(
                    ...
                    Row(
                        ...
                        Text(text = stringResource(id = R.string.sign_up_is_adulto_label))
                    }
                    Column {
                        Column(
                            modifier = Modifier
                                ...
                                Button(
                                    ...
                                    Row(
                                        ...
                                        Text(
                                            ...
                                            fontStyle = FontStyle.Normal,
                                            fontWeight = FontWeight.Bold,
                                            text = stringResource(id = R.string.sign_up_create_account_bottom_message)
                                        )
                                    }
                                }
                            }
